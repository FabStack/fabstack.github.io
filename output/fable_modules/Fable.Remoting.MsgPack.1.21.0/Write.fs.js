import { uncurry2, disposeSafe, isDisposable, getEnumerator, count, curry2, defaultOf } from "../fable-library.4.9.0/Util.js";
...
function cacheGetOrAdd(typ, f) {
    ...
    if (matchValue[0]) {
        ...
        addToDict(serializerCache, fullName(typ), curry2(f));
        return (arg_2) => {
            const clo_1 = curry2(f)(arg_2);
            return (arg_3) => {
                clo_1(arg_3);
            };
        };
...
function writeArray(out, t, arr) {
    ...
    try {
        while (enumerator["System.Collections.IEnumerator.MoveNext"]()) {
            const x = enumerator["System.Collections.IEnumerator.get_Current"]();
            writeObject(x, t, out);
        }
    }
    finally {
        ...
        if (matchValue[0]) {
            ...
            if (equals(tDef, list_type(obj_type))) {
                ...
                cacheGetOrAdd(t, (x_9, out_11) => {
                    ...
                    const values = patternInput_1[1];
                    const tag = patternInput_1[0] | 0;
...
//# sourceMappingURL=Write.fs.js.map
