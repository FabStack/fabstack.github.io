...
export function createTypeInfo(resolvedType) {
    ...
    if (matchValue[0]) {
        ...
        const notAnonymousRecord = (!isNullOrEmpty(fullName(resolvedType)) && !endsWith(fullName(resolvedType), "`1[]")) && !endsWith(fullName(resolvedType), "`2[]");
