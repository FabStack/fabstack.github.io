...
import { join, toText, fromBase64String, printf, toFail, substring, endsWith } from "../fable-library.4.9.0/String.js";
...
import { toInt64 as toInt64_1, getBytesInt32 } from "../fable-library.4.9.0/BitConverter.js";
...
export function Convert_flattenMap(_arg) {
    switch (_arg.tag) {
        case 1: {
            const value = _arg.fields[1];
            const key = _arg.fields[0];
            return singleton([key, value]);
        }
        case 2: {
            const value_1 = _arg.fields[1];
            const right = _arg.fields[3];
            const left = _arg.fields[2];
            const key_1 = _arg.fields[0];
...
export function Convert_flattenFable3Lists(linkedList) {
    return toList(delay(() => {
        ...
        return append((matchValue = tryFind("head", linkedList), (matchValue == null) ? (empty_1()) : ((value = matchValue, singleton_1(value)))), delay(() => {
...
export function Convert_isRecord(_arg) {
    if (_arg.tag === 39) {
        const recordType = _arg.fields[0];
        return true;
    }
    else {
        return false;
...
export function Convert_fromJsonAs(input_mut, typeInfo_mut) {
    let foundCase, foundCase_1, testExpr, otherwise, otherwise_1, tree, comparer, tree_1, comparer_1, value, value_1, optionalTypeDelayed, jsonValue, getTypes, caseName, optionalTypeDelayed_1, jsonValue_1, optionalTypeDelayed_2, jsonValue_2, optionalTypeDelayed_3, jsonValue_3, optionalTypeDelayed_4, jsonValue_4;
    Convert_fromJsonAs:
    while (true) {
        ...
        switch (input.tag) {
            case 1: {
                switch (typeInfo.tag) {
                    ...
                    case 27: {
                        if ((optionalTypeDelayed = typeInfo.fields[0], (jsonValue = input, !equals(jsonValue, new Json(3, []))))) {
                            matchResult = 46;
                            jsonValue_5 = input;
            ...
            case 2: {
                switch (typeInfo.tag) {
                    ...
                    case 27: {
                        if ((optionalTypeDelayed_1 = typeInfo.fields[0], (jsonValue_1 = input, !equals(jsonValue_1, new Json(3, []))))) {
                            matchResult = 46;
                            jsonValue_5 = input;
                            optionalTypeDelayed_5 = typeInfo.fields[0];
                        }
            ...
            case 5: {
                switch (typeInfo.tag) {
                    ...
                    case 27: {
                        if ((optionalTypeDelayed_2 = typeInfo.fields[0], (jsonValue_2 = input, !equals(jsonValue_2, new Json(3, []))))) {
                            matchResult = 46;
                            jsonValue_5 = input;
                            optionalTypeDelayed_5 = typeInfo.fields[0];
                        }
            ...
            case 4: {
                switch (typeInfo.tag) {
                    ...
                    case 27: {
                        if ((optionalTypeDelayed_3 = typeInfo.fields[0], (jsonValue_3 = input, !equals(jsonValue_3, new Json(3, []))))) {
                            matchResult = 46;
                            jsonValue_5 = input;
                            optionalTypeDelayed_5 = typeInfo.fields[0];
                        }
            ...
            default:
                switch (typeInfo.tag) {
                    ...
                    case 27: {
                        if ((optionalTypeDelayed_4 = typeInfo.fields[0], (jsonValue_4 = input, !equals(jsonValue_4, new Json(3, []))))) {
                            matchResult = 46;
                            jsonValue_5 = input;
                            optionalTypeDelayed_5 = typeInfo.fields[0];
                        }
        ...
        switch (matchResult) {
            ...
            case 40: {
                const seconds = toInt64(fromFloat64(Math.floor(value_39)));
            ...
            case 44: {
                ...
                switch (matchResult_1) {
                    case 0: {
                        ...
                        if (_arg != null) {
                            if ((foundCase = _arg, (foundCase.CaseTypes.length === 1) && Convert_arrayLike(foundCase.CaseTypes[0]))) {
                                ...
                                const deserialized = Convert_fromJsonAs(new Json(4, [values_1]), foundCase_2.CaseTypes[0]);
                    ...
                    default:
                        if ((otherwise = matchValue_3, (containsKey("tag", values) && containsKey("fields", values)) && (count(values) === 2))) {
                            const otherwise_2 = matchValue_3;
                            ...
                            switch (matchResult_3) {
                                case 0: {
                                    ...
                                    const values_2 = mapIndexed((index, value_48) => Convert_fromJsonAs(value_48, foundCase_5.CaseTypes[index]), toArray(fieldValues));
                ...
                switch (matchResult_5) {
                    case 0: {
                        ...
                        if (_arg_5 == null) {
                            ...
                            const arg_41 = name_2(unionType_3);
            ...
            case 56: {
                ...
                return map_3((value_59) => Convert_fromJsonAs(value_59, elementType_2), flattenedList);
            }
            case 57: {
            ...
            case 58: {
                ...
                const converted = map_3((value_63) => Convert_fromJsonAs(value_63, elementType_4), values_7);
                return converted;
            }
            case 59: {
                ...
                }, zip(tupleTypes, toArray(array_12)));
            }
            case 60: {
                    ...
                    if (_arg_9 == null) {
                        if (fieldType.tag === 27) {
                            ...
                            const arg_53 = join(", ", map_2((_arg_10) => {
                                ...
                                const innerFieldType = _arg_10.FieldType;
                                if (innerFieldType.tag === 27) {
            ...
            case 61: {
                ...
                const pairs = toList(delay(() => collect((keyValuePair) => {
                    let a;
                    const tuple_1 = Convert_fromJsonAs(keyValuePair, new TypeInfo(32, [(a = [keyType, valueType_2], () => a)]));
            ...
            case 62: {
                ...
                const pairs_1 = toList(delay(() => collect((keyValuePair_1) => {
                    const tuple_2 = Convert_fromJsonAs(keyValuePair_1, new TypeInfo(32, [() => [keyType_1, valueType_3]]));
            ...
            case 63: {
                ...
                const pairs_2 = map_3((tupledArg_4) => {
                    ...
                    const value_74 = tupledArg_4[1];
                    return [Convert_fromJsonAs(new Json(1, [key_4]), keyType_2), Convert_fromJsonAs(value_74, valueType_4)];
                }, toList_1(dict_2));
                    ...
                    if (matchValue_7.tag === 5) {
                        if (matchValue_8 != null) {
                            switch (matchValue_8.tag) {
                                case 4: {
                                    if ((tree = matchValue_8.fields[0], (comparer = matchValue_7.fields[0], isEmpty_1(comparer)))) {
                                        matchResult_6 = 0;
                                ...
                                case 5: {
                                    if ((tree_1 = matchValue_8.fields[0], (comparer_1 = matchValue_7.fields[0], isEmpty_1(comparer_1)))) {
                                        matchResult_6 = 1;
                ...
                switch (matchResult_6) {
                    case 0: {
                        ...
                        if (matchValue_10 == null) {
                            ...
                            const internalMap = matchValue_10;
                            const pairs_3 = map_3((tupledArg_5) => {
                                const key_6 = tupledArg_5[0];
                                const value_81 = tupledArg_5[1];
                                ...
                                const nextValue = Convert_fromJsonAs(value_81, valueType_5);
                    ...
                    default: {
                        const pairs_4 = map_3((tupledArg_6) => {
                            ...
                            const nextValue_1 = Convert_fromJsonAs(value_86, valueType_5);
        ...
        switch (typeInfo.tag) {
            ...
            case 39: {
                ...
                const serializedFields = map_2((field) => {
                    ...
                    const arg_1 = Convert_serialize(fieldValue, field.FieldType);
            ...
            case 27: {
                ...
                if (matchValue != null) {
                    const existingValue = value_91(matchValue);
            ...
            case 40: {
                ...
                const caseTypes = find_1((case$) => (case$.CaseName === name_2(usedCase)), unionCases).CaseTypes;
